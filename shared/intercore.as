...
x3:					// r3 is current destination address
	sub	r4,r4,1
...
_sfb_internal:
	lsr	wq,r4,5			// frame cache line into message
	ld	r4,16			// r4 = len << 4 (type is 0)
	add_lsl	r4,r4,r3,5		// r4 = (r4 + dest) << 5
	aqw_add	r4,r4,msgControl	// initiate the message send
	ld	r1,rq			// result
	j	link
